...
<div class="content-wrapper" style="min-height: 933px;">
	<section class="content-header">
		<h1>Homeowner Settings</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> 
			<li class="active">Homeowner Settings</li>
		</ol>
  </section>
		...
		<div class="user-setting col-xs-12">
			<div class="row">
				...
				if (isset($this->session->message)) {
					...
					if ($message == 'Homeowner setting Updated Successfully') { ?>
				...
				<div class="col-sm-9 box settings-frm" style="padding-left:1px;">
					<div class="user-right-side" style="margin-top:30px;">
						<form action="<?= site_url().'Admin/Admin/update_homeowner_sharable'; ?>" id="update_profile" method="post" enctype="multipart/form-data">  
							<input type="hidden" name="shareable" value="homeowner-setting">
											...
											<div class="form-group">
												...
												<div class="col-md-4 control-label" style="padding-left: 0px;padding-right: 33px;">
													<div class="input-group">
														...
														<input name="min_amount_cashout_h" placeholder="" class="form-control input-md" type="number" step="0.01" min="0" value="<?php echo $min_cashout_homwowner;?>" required="">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<input  name="min_quotes_received_h" placeholder="" class="form-control input-md" type="number" step="1" min="0" value="<?php echo $min_quotes_received_homeowner_h;?>" required >
										...
										<div class="col-sm-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<div class="input-group">
														<span class="input-group-addon">£</span>
															<input  name="comission_ref_hh" placeholder="" class="form-control input-md" type="number" step="0.01" min="0" value="<?php echo $comission_ref_homeowner_h;?>" required >
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<input  name="min_quotes_approved_h" placeholder="" class="form-control input-md"  type="number" step="1" min="0" value="<?php echo $min_quotes_approved_tradsman_h;?>" required >
										...
										<div class="col-sm-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<div class="input-group">
														<span class="input-group-addon">£</span>
														<input  name="comission_ref_th1" placeholder="" class="form-control input-md"  type="number" step="0.01" min="0" value="<?php echo $comission_ref_tradsman_h;?>" required >
