...
<div class="content-wrapper" style="min-height: 933px;">
	<section class="content-header">
		<h1>Tradesman Setting</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> 
			<li class="active">Tradesman Setting</li>
		</ol>
  </section>
		...
		<div class="user-setting col-xs-12">
			<div class="row">
				...
				if (isset($this->session->message)) {
					...
					if ($message == 'Tradesman Setting Updated Successfully') { ?>
										...
										<div class="col-sm-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<div class="input-group">
														<span class="input-group-addon">£</span>
														<input  name="comission_ref_th" placeholder="" class="form-control input-md" type="number" step="0.01" min="0" value="<?php echo $comission_ref_homeowner_t;?>" required >
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="input-group">
													<span class="input-group-addon">£</span>
													<input  name="comission_ref_tt" placeholder="" class="form-control input-md" type="number" step="0.01" min="0" value="<?php echo $comission_ref_tradsman_t;?>" required >
