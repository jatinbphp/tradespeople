<div class="form-group">
    ...
    <input type="text" name="code" required class="form-control" value="<?php echo ($coupon['code'] ??  '') ?>" placeholder="Enter Code">
</div>
<div class="form-group">
    <label for="is_limited"> Select Is Limited:</label>
    <select name="is_limited" data-id="<?php echo $coupon['id'] ?? 0 ?>" class="form-control is-limited-user-selection" required>
...
<div class="form-group">
    ...
    <input type="number" min="1" step="1" name="discount" required class="form-control" value="<?php echo ($coupon['discount'] ??  0) ?>" placeholder="Enter Discount">
</div>
<div class="form-group">
