...
<div class="content-wrapper" style="min-height: 933px;">
	<section class="content-header">
		<h1>Homeowner Sharable Links</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> 
			<li class="active">Homeowner Sharable</li>
		</ol>
  </section>
		...
		<div class="user-setting col-xs-12">
			<div class="row">
				...
				if (isset($this->session->message)) {
					...
					if ($message == 'Homeowner Sharable Links Updated Successfully') { ?>
			...
			<div class="row">
				<div class="col-sm-9 box settings-frm" style="padding-left:1px;">
					<div class="user-right-side" style="margin-top:30px;">
						<form action="<?= site_url().'Admin/Admin/update_homeowner_sharable'; ?>" id="update_profile" method="post" enctype="multipart/form-data">  
												...
												<div class="col-md-8 append_input">
													...
													if(!empty($homeowner_ref_links_hm)){
														for($k=0;$k<count($homeowner_ref_links_hm);$k++){
															if(($k+1) == count($homeowner_ref_links_hm)){?>
																<div class="row" style="margin-top:10px;">
																	<div class="col-lg-11" style="padding-right: 0px;">
																		<input name="homeowner_homeowner[]" placeholder="" class="form-control input-md" type="url" value="<?php echo $homeowner_ref_links_hm[$k] ?>" required="">
																	</div>
																	<div class="col-lg-1 plus_div" style="padding-left: 4px;">
																		<span style="background: #222d32;color:#fff;margin-top: 15px;cursor: pointer;" attr-type="homeowner_homeowner" class="badge add_inputs">+</span>
																	</div>
																</div>
															<?php
															}else{?>
															<div class="row" style="margin-top:10px;">
																<div class="col-lg-11" style="padding-right: 0px;">
																	<input name="homeowner_homeowner[]" placeholder="" class="form-control input-md" type="text" value="<?php echo $homeowner_ref_links_hm[$k] ?>" required="">
																</div>
														...
														<div class="row" style="margin-top:10px;">
															<div class="col-lg-11" style="padding-right: 0px;">
																<input name="homeowner_homeowner[]" placeholder="" class="form-control input-md" type="text" value="" required="">
															</div>
															<div class="col-lg-1 plus_div" style="padding-left: 4px;">
																<span style="background: #222d32;color:#fff;margin-top: 15px;cursor: pointer;" attr-type="homeowner_homeowner" class="badge add_inputs">+</span>
															</div>
													...
													if(!empty($homeowner_ref_links_tm)){
														for($l=0;$l<count($homeowner_ref_links_tm);$l++){
															if(($l+1) == count($homeowner_ref_links_tm)){?>
																<div class="row" style="margin-top:10px;">
																	<div class="col-lg-11" style="padding-right: 0px;">
																		<input name="homeowner_tradsman[]" placeholder="" class="form-control input-md" type="url" value="<?php echo $homeowner_ref_links_tm[$l]?>" required="">
																	</div>
																	<div class="col-lg-1 plus_div" style="padding-left: 4px;">
																		<span style="background: #222d32;color:#fff;margin-top: 15px;cursor: pointer;" attr-type="homeowner_tradsman" class="badge add_inputs">+</span>
																	</div>
																</div>
															<?php
															}else{?>
															<div class="row" style="margin-top:10px;">
																<div class="col-lg-11" style="padding-right: 0px;">
																	<input name="homeowner_tradsman[]" placeholder="" class="form-control input-md" type="text" value="<?php echo $homeowner_ref_links_tm[$l] ?>" required="">
																</div>
																<div class="col-lg-1 plus_div" style="padding-left: 4px;"><i class="fa fa-trash" style="margin-top: 16px;font-size: 19px;"></i>
																</div>
															</div>
															<?php }
														}
														...
														<div class="row" style="margin-top:10px;">
															<div class="col-lg-11" style="padding-right: 0px;">
																<input name="homeowner_tradsman[]" placeholder="" class="form-control input-md" type="text" value="" required="">
															</div>
															<div class="col-lg-1 plus_div" style="padding-left: 4px;">
																<span style="background: #222d32;color:#fff;margin-top: 15px;cursor: pointer;" attr-type="homeowner_tradsman" class="badge add_inputs">+</span>
															</div>
