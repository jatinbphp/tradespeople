...
<table id="boottable" class="table table-bordered table-striped">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php $get_user=$this->common_model->get_single_data('users',array('id'=>$list['userid'])); echo $get_user['f_name'].' '.$get_user['l_name']; ?></td>
                
			<td><?php echo ($list['budget'])?'£'.$list['budget']:''; ?><?php echo ($list['budget2'])?' - £'.$list['budget2']:''; ?></td>
                
			<td style="display: none;"><?php echo $list['delivery_days'].' days';  ?></td>
                
			<td>
				<?php 
				$len=strlen($list['description']); 
				if($len>100){
					 echo substr($list['description'],0,100); 
				?>  <a href="javascript:void(0);" class="btn btn-warning btn-xs"  data-toggle="modal" data-target="#add_category<?php echo $list['job_id']; ?>">Read More</a><?php
        ...
        <div class="input-append1">
          <div id="fields">
                     <input type="text" name="post_id" id="post_id" value="<?php echo $list['id']; ?>">
                         <input type="text" name="bid_by" id="bid_by" value="<?php echo $list['bid_by']; ?>">
                         <input type="text" name="amounts" id="amounts" value="<?php echo $list['bid_amount']; ?>">
        </div>
      </div>
