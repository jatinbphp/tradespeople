...
<div class="home-page">
 <div class="home-demo first-home">
	<div class="owl-carousel banner-slider">
		<div class="item">
			<div class="set-slide" style="background: url(img/banner.png);"><svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 740 650" version="1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon opacity="0.8" fill="#FFFFFF" points="0 0 740 0 700 650 0 650"></polygon></svg>
				<div class="container">
        ...
        <div class="col-sm-10">
					...
					<h1 class="nomargin">How MyBuilder works</h1>
...
<div class="Advice_c paddg_0">
	<div class="container">
		...
		<h1 class="head-home">Advice guides</h1>
		<div class="row">
			<div class="col-sm-4">
				<a class="boxus_1">
