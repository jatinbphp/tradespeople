					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-12">
								...
								<input type="text" class="form-control input-lg" minlength="16" maxlength="16" id="card" name="card" placeholder="0000 0000 0000 0000" required="">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-sm-12">
								...
								<input type="text" name="name" class="form-control input-lg" placeholder="Name on card" required="">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								...
								<input class="form-control input-lg" name="expiry" id="expiry" type="text" required="" placeholder="MM/YY">
							</div>
							<div class="col-sm-6">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-12 text-right">
								<button class="btn btn-warning btn-lg" type="submit">Buy Now</button>
							</div>
						</div>
					</div>
			...
			<div class="col-sm-4">
				<div class="card-summary">
					<div class="celebration-box">
						...
						<p>Enjoy 8.9% fees on your first order! Buy today and save $5.</p>
					</div>
					<div class="summary-box">
						...
						<div class="summary-feature-article">
							<a href="#">
								<img src="http://localhost/tradespeople/img/stp-3d.jpg" class="img-responsive">
								<p>"feature Article on New Yirk Weekly Nyweekly dofollow"</p>
							</a>
						</div>
						<ul>
							<li>
