			 ...
			 <div class="modal-body port-deatil" style="padding:0px;">
               ...
               <?php } ?>
                  ...
                  <div class="dashboard-profile">
                    ...
                    <?php if($this->session->userdata('user_id')==$this->uri->segment(2)){ if(empty($user_profile['insurance_liability'])){ ?>
                     <div class="col-md-12">
                        <div class="pull-right margintop10">
                  ...
                  <div class="dashboard-profile ">
                     ...
                     <form method="post" id="direct_hire" enctype="multipart/form-data"  onsubmit="return direct_hiring();">
                        ...
                        <div class="from-group"  style="margin-top: 30px;">
                           ...
                           <a href="javascript:void(0);" onclick="swal('You had aleady sent a hiring request for the job Id: <?php echo $check_last_request['project_id']; ?>');" class="btn btn-primary btn-lg btn-block hire_me">Hire Me</a>
                           <?php } else { ?>
                           <button type="submit" class="btn btn-primary btn-lg btn-block hire_me">Hire Me</button>
                           <?php } ?>
                           <?php } else { ?>
                           <a href="<?php echo site_url().'login'; ?>" class="btn btn-primary btn-lg btn-block hire_me">Hire Me</a>
                           <?php } ?>
                        </div>
                     </form>
                     <p>
