							...
							<div class="row">
								<div class="col-sm-6">
									<div class="slice-text slice-text_home">
										...
										$find_job_content=$this->common_model->GetColumnName('other_content',array('id'=>2));
	...
	<div class="container">
		<div class="row">
			...
			<div class="input-group">
				...
				<!-- loop -->
					<div  id="search_data">
				<?php if($all_jobs){ foreach ($all_jobs as $jobs) {?>
			...
			<div class="col-sm-4 floss1">
				<div class="fat-side-item fiilter">
					...
					<div class="from-group hide">
						...
						<select class="form-control" name="category_id"  id="category_id" onchange="searchFilter1();">
					...
					<div class="from-group">
						...
						<select class="form-control" name="city_id"  id="city_id"  onchange="searchFilter1();" >
							<option value="">Select Town/City</option>
							<?php	foreach ($cities as $city) {
								 $selected = (isset($searchCity) && $searchCity==$city['city']) ? 'selected' : '';
							?>
							<option  <?php echo $selected; ?> value="<?php echo $city['city']; ?>"><?php echo $city['city']; ?></option>
						<?php } ?>
					 ...
					 <button type="submit" class="button btn btn-default hide" onclick="searchFilter();">Search</button>
				</div>
...
function searchFilter1(page_num)
{
	...
	if($categoryId == '' && $cityId == ''){
		window.location.href=site_url + "find-jobs/" 
	} else {
		if($categoryId  == '') {
			$categoryId = ' ';
		}
		window.location.href=site_url + "find-jobs/"+$categoryId+"/"+$cityId;
	}
	// if(page_num){
...
function searchFilter(page_num)
{
	...
	$.ajax({ 
		...
		data:'page_num='+page_num+'&search1='+search1+'&category_id='+category_id+'&location='+location+'&amount1='+amount1+'&amount2='+amount2+'&city_id='+cityId,
		dataType:'JSON',
		beforeSend:function()
		{
