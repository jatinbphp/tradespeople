				...
				<div class="row"> 
					...
					<div class="col-sm-6">
						<div class="login-box">
							...
							<div class="text-sign">
								<h3 style="margin-bottom: 12px;">I´m a marketer</h3>
								<p>Create an account here</p>
								<a href="<?php echo base_url('affiliaters_signup'); ?>" class="text-href">Create an account</a>
							</div>
...
function login_form(){
	$.ajax({
		type:'POST',
		url:site_url+'home/marketer_login_form',
		...
		success:function(resp){
			if(resp.status==1){
				...
				window.location.href=site_url+'home/marketer_email_verify'; 
