        ...
        <div class="verify-page">
          <div class="message_manb">
            <div class="mjq-sh man_osp1">
							...
							<h2><strong>Message Center</strong></h2>
							<?php } else { ?>
							<h2><strong>Create a support ticket</strong></h2>
							<?php } ?>
            ...
            <div class="manage-profile mrsssagen_cantet_555">
               ...
               <p>Please write your message below and we´ll get back as soon as possible.</p>
                       ...
                       <br>
                            ...
                            <label>Message</label>
                            <textarea style="height: 130px" name="message" class="form-control" required id="message" placeholder="Please be as detailed as possible so that we can give you a tailored response."></textarea>
...
function send_message(e){
	...
	$.ajax({
		...
		success:function(response){
			if(response.status == 1) window.location.href = site_url+"/Support/details/" + response.admin_chat_id;
