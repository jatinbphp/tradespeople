  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3">
        <h1 class="head-home">Cost guides</h1>
        <p class="text-center">
    ...
    <div class="row">
      ...
      ?>
          <div class="col-sm-4">
            <a class="boxus_1">
              <img src="img/costguide/<?=$costGuide['image'];?>" class="img_r">
              <div class="contt">
                <a href="cost-guide-detail/<?=$costGuide['id'];?>">
                  <h4><?=$costGuide['title'];?></h4>
                </a>
                <!--
                <p><?=substr($costGuide['description'], 50);?></p>
                -->
              </div>
            </a>
          </div>
