...
<div class="container">
  ...
  <p>This is the page created only for stripe live test</p>
	<div class="row">
		<form id="payment-form" onsubmit="">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="number" value="1" onkeyup="change_amount(this.value)" placeholder="amount" id="amount" class="form-control" required>
				</div>
			</div><br>
      ...
      <p id="card-error" role="alert"></p> <br>
...
function change_amount(amount){
	...
	fetch("<?php echo site_url(); ?>home/createPaymentIntent/"+amount, {
		method: "POST",
		headers: {
...
var payWithCard = function(stripe, card, clientSecret) {
  ...
  stripe.confirmCardPayment(clientSecret, {
		...
		if (result.error) {
			...
			showError(result.error.message,result);
		} else {
...
var showError = function(errorMsgText,result) {
  loading(false);
