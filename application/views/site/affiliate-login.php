				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="login-box">
							...
							<div class="text-sign">
								<h3 style="margin-bottom: 12px;">I´m an affiliate</h3>
								<p>Create an account here to start profiting from our affiliate program.</p>
								<a href="<?php echo base_url('affiliate-signup'); ?>" class="text-href">Create an account</a>
							</div>
