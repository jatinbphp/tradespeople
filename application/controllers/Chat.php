...
class Chat extends CI_Controller
{
  ...
  */
  ...
  public function makeDiv($row){
  	$serviceDiv = '';
  	$userid=$this->session->userdata('user_id');
  	if($userid == $row['receiver_id'] && $row['type'] == 'service'){
