...
$email 		=	'nilesh.youngdecade@gmail.com';
$email 		=	'jonpro@mailinator.com';
//$email 		=	'nileshthakur1006@gmail.com';
...
echo $mailResponse = mailSend($email, $fromName, $subject, $mailBody, $mail_file);
	...
	function mailBodySendDataEmailVerification($postData){
        $body = '';
        $body.=	'<html><head><meta http-equiv="Content-Language" content="en-us"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body marginheight="0"><table border="0" cellpadding="0" cellspacing="0" width="100%"> 
                        <tbody> 
                            <tr> 
                            ...
                            <tbody> 
                                ...
                                <tbody> 
									...
									<p style="margin: 0 ; font-size: 20px ; padding-bottom: 5px ; color: #2875d7">Please verify your email address.</p> <p style="margin: 0 ; padding: 10px 0px">Thanks for registering with Tradespeople Hub! To finish your sign up, please verify your email address by clicking the button below.</p> 
