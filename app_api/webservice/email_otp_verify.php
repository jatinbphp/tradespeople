<?php	
	...
	//-------------------------- check otp --------------------------
	$check_otp_all=$mysqli->prepare("SELECT `unique_id`, `f_name`, `l_name`, phone_code,email from users where id=? and email_code=?");
	...
	$update_all=$mysqli->prepare("UPDATE users set u_email_verify=? WHERE id=? ");
